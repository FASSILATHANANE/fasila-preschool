      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md shadow-sm">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 md:px-8 py-3">
          ...
          <nav className="hidden lg:flex items-center gap-1 bg-green-700 px-3 py-2 rounded-2xl shadow-md">
            ...
            <a
              href="/"
              className="text-white font-bold px-3 py-2 rounded-xl hover:bg-green-600 hover:text-yellow-300 transition"
            >
              الرئيسية
            </a>
            ...
            <a
              href="/jobs"
              className="bg-yellow-400 text-green-900 font-extrabold px-4 py-2 rounded-xl hover:bg-yellow-300 transition shadow-sm"
            >
              💼 عروض العمل
            </a>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-y-4">
                ...
                <a
                  href="/jobs"
                  className="text-yellow-300 font-extrabold hover:text-yellow-200 transition"
                >
                  💼 عروض العمل
                </a>
